...
import FloorPlanLeadModal from "./FloorPlanLeadModal"; // Apne path ke hisaab se adjust karein
...
const Footer = () => {
  ...
  const exploreLinks = [
    ...
    { name: "Floor Plans", path: "/floor-plans", isModal: true }, // custom flag or check by name
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-4">
                {exploreLinks.map((item, i) => (
                  <li key={i}>
                    {item.name === "Floor Plans" ? (
                      <button
                        onClick={handleFloorPlanClick}
                        className="flex items-center gap-2 text-sm group cursor-pointer text-left bg-transparent border-none p-0"
                        style={{
