...
<motion.button
  whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}
  onClick={() => {
    // Window.open ka use karke PDF ko naye tab mein open karein
...
//         <div className="absolute inset-0"
//           style={{ background: 'linear-gradient(105deg, rgba(26,26,26,0.85) 0%, rgba(26,26,26,0.5) 55%, rgba(26,26,26,0.2) 100%)' }} />
//         <div className="absolute inset-0"
//           style={{ background: 'linear-gradient(to top, rgba(26,26,26,0.6) 0%, transparent 50%)' }} />
//       </div>
